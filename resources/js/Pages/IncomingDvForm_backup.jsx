...
export default function IncomingDvForm() {
  ...
  const validateDvNumber = (value) => {
    // Since we auto-format with current year/month, just validate the final format
  ...
  const validateForm = () => {
    ...
    // Validate ORS entries only if they have values (optional fields)
  ...
  const handleChange = (e) => {
    ...
    // Format and limit input based on field type
    ...
    if (name === 'dv_number') {
      ...
      // Only allow editing after the year-month prefix
      if (value.startsWith(yearMonthPrefix)) {
        // Extract only the serial number part
        ...
        // If user tries to modify the prefix, reset to prefix only
  ...
  const handleOrsChange = (index, field, value) => {
    ...
    if (field === 'ors_number') {
      ...
      // Limit to 22 digits (2+8+4+2+6)
      numbers = numbers.slice(0, 22);
      
      // Format as NN-NNNNNNNN-YYYY-MM-NNNNNN
      if (numbers.length > 0) {
        if (numbers.length <= 2) {
    ...
    if (field === 'uacs') {
      // Remove all non-digits first
      let numbers = value.replace(/\D/g, '');
      // Limit to 10 digits (8+2)
      numbers = numbers.slice(0, 10);
      
      // Format as NNNNNNNN-NN
      if (numbers.length > 0) {
        if (numbers.length <= 8) {
          formattedValue = numbers;
        } else {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200">
        ...
        <div className="bg-green-700 text-white p-4 shadow-xl sticky top-0 z-50">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center group">
              ...
              />
              <h1 className="text-xl font-medium text-yellow-400 group-hover:text-yellow-300 transition-colors duration-300" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.5)' }}>
        ...
        <div className="relative max-w-7xl mx-auto p-8">
          ...
          <div className="text-center mb-8 animate-fade-in">
            ...
            <p className="text-gray-600 hover:text-gray-700 transition-colors duration-300 cursor-default">
            ...
            <div className="p-8">
              <form onSubmit={submit} className="space-y-8">
                ...
                <div className="space-y-6">
                  {/* First row: Type, DV Number, Payee */}
                  ...
                  {/* Second row: Implementing Unit, Account Number */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="group">
                      ...
                      <ComboBox
                        ...
                        options={unitOptions}
                        placeholder="Select or type implementing unit (optional)"
                ...
                <div className="border-t border-gray-200 pt-6">
                  <div className="bg-gray-50 rounded-lg p-6 hover:bg-gray-100 transition-all duration-300">
                    <h4 className="text-lg font-medium text-gray-800 mb-4 flex items-center">
                      ...
                      ORS Information (Optional)
                    </h4>
                    {orsList.map((entry, index) => (
                      <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border border-gray-200">
                        <div className="group">
                          <label className="text-sm font-medium text-gray-700 block mb-2 group-hover:text-green-600 transition-colors duration-300">
                            ORS No.
                          </label>
                          <input
                            type="text"
                            placeholder="NN-NNNNNNNN-YYYY-MM-NNNNNN (optional)"
                            value={entry.ors_number}
                            onChange={(e) => handleOrsChange(index, 'ors_number', e.target.value)}
                            className={`w-full border-2 rounded-lg p-3 focus:outline-none transition-all duration-300 hover:shadow-sm ${
                        ...
                        <div className="group">
                          ...
                          <ComboBox
                            ...
                            placeholder="Select or type fund source (optional)"
                            className="transition-all duration-300 hover:shadow-sm border-gray-300 focus:border-green-500 hover:border-green-400"
                          />
                        </div>
                        ...
                        <div className="group">
                          ...
                          <div>
                            <ComboBox
                              ...
                              options={uacsOptions}
                              placeholder="NNNNNNNN-NN (optional)"
